...
class SystemSettingsBase(BaseModel):
    ...
    app_name: Optional[str] = Field(None, max_length=255, description="Application name")
    ...
    # Email Configuration
    smtp_server: Optional[str] = Field(None, max_length=255, description="SMTP server address")
    ...
    frontend_url: Optional[str] = Field(None, max_length=500, description="Frontend URL")
    
    # Security Settings
    session_timeout_minutes: Optional[int] = Field(30, ge=5, le=1440, description="Session timeout in minutes")
    max_login_attempts: Optional[int] = Field(5, ge=1, le=20, description="Maximum login attempts")
    
    # Feature Flags
    email_notifications_enabled: Optional[bool] = Field(True, description="Enable email notifications")
    user_registration_enabled: Optional[bool] = Field(True, description="Enable user registration")
