...
# Email configuration - only initialize if we have valid settings
email_config = None
if config.SMTP_USERNAME and config.SMTP_PASSWORD and config.FROM_EMAIL and "@" in config.FROM_EMAIL:
